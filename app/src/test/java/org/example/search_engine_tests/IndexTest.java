...
public class IndexTest {
    ...
    public void postings() {
        ...
        TestUtils.assertListAreEqualIgnoringOrder(index.getPostings("when"), Arrays.asList(new Posting(id2, "when", 1), new Posting(id1, "when", 1)));
        
        
        assertEquals(Arrays.asList(new Posting(id1, "title", 1), new Posting(id2, "title", 1)), index.getPostings("title"));
